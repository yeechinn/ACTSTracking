...
//    float impact = impactParametersVec[i];
    ...
    float straightnessx = (bottomSP.x()-middleSP.x())-(middleSP.x()-topSpVec[i]->x());
    float straightnessy = (bottomSP.y()-middleSP.y())-(middleSP.y()-topSpVec[i]->y());
    float weight = -(straightnessx*straightnessx+straightnessy*straightnessy);
/*
